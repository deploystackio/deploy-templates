# 🚀 Generated IaC Templates for youtube-dl-server

> This repository contains automatically generated Infrastructure as Code templates by [DeployStack.io](https://deploystack.io/c/nbr23-youtube-dl-server)

## ⚡ One-Click Deploy

| Cloud Provider | Deploy Button |
|---------------|---------------|
| AWS | <a href="https://deploystack.io/deploy/nbr23-youtube-dl-server?provider=aws&language=cfn"><img src="https://github.com/htdio-stg/deploy-templates/blob/main/.assets/img/aws.svg" height="38"></a> |
| DigitalOcean | <a href="https://deploystack.io/deploy/nbr23-youtube-dl-server?provider=do&language=dop"><img src="https://github.com/htdio-stg/deploy-templates/blob/main/.assets/img/do.svg" height="38"></a> |
| Render | <a href="https://deploystack.io/deploy/nbr23-youtube-dl-server?provider=rnd&language=rnd"><img src="https://github.com/htdio-stg/deploy-templates/blob/main/.assets/img/rnd.svg" height="38"></a> |
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install nbr23-youtube-dl-server deploystack/nbr23-youtube-dl-server` |
...
- **Source Repository**: https://github.com/nbr23/youtube-dl-server
- **License**: MIT License
...
Original source: https://github.com/nbr23/youtube-dl-server
