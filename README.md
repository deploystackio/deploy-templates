...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install marcopiovanello-yt-dlp-web-ui deploystack/marcopiovanello-yt-dlp-web-ui` |
